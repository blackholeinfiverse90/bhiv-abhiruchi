...
export default function Home() {
  ...
  const homeContent = (
    <div className="w-full flex items-center justify-center p-2 sm:p-4 py-4 text-white">
      <div className="w-full max-w-4xl flex items-center justify-center">
        <div className="w-full bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-6 sm:p-8 space-y-6 relative">
          {/* Decorative elements */}
